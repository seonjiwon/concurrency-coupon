...
@Slf4j
@Transactional
public class CouponServiceV0Basic implements CouponService{
    ...
    public CreateCouponResponse createCoupon(CreateCouponRequest request) {
        ...
        return CouponResponse.CreateCouponResponse.builder()
    ...
    @Override
    public void issue(Long couponId, IssueCouponRequest request) {
        // 1. 읽기
